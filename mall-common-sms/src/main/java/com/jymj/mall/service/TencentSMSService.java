package com.jymj.mall.service;

import cn.hutool.core.util.RandomUtil;
import com.jymj.mall.common.constants.SecurityConstants;
import com.jymj.mall.config.TencentSMSProperties;
...
public class TencentSMSService {
     ...
     * @param args   参数
     */
    private boolean send(String mobile, String templateId, String[] args) {
        log.info("发送短信：手机号：{}，模板ID：{}，参数：{}", mobile, templateId, args);
